  ...
  return (
    <div className="space-y-4">
      ...
      <div className="glass-card p-6">
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="group relative">
                  ...
                  {client_id && client_id.length > 20 && (
                    <div className="absolute bottom-full left-0 mb-2 px-3 py-2 bg-slate-900 text-white text-sm rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 z-10 max-w-xs break-words">
                      {client_id}
        ...
        {/* Total Amount */}
        <div className="glass-card-hover p-4 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200/50">
