...
const ResultsTable = ({ data, autoConvertCurrency }) => {
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 mb-4 sm:mb-6">
          <div className="glass-card-hover p-3 sm:p-4 relative overflow-hidden dark">
            ...
            <div className="flex items-center space-x-3 sm:space-x-4">
              ...
              <div className="min-w-0 flex-1">
                <p className="text-xs sm:text-sm font-medium text-slate-400">Company</p>
          ...
          <div className="glass-card-hover p-3 sm:p-4 relative overflow-hidden dark">
            ...
            <div className="flex items-center space-x-3 sm:space-x-4">
              ...
              <div className="min-w-0 flex-1">
                <p className="text-xs sm:text-sm font-medium text-slate-400">Client ID</p>
                <div className="group relative">
                  <p className="text-sm sm:text-lg font-semibold text-white truncate">
                    {client_id || 'N/A'}
                  </p>
                  {client_id && client_id.length > 20 && (
                    <div className="absolute bottom-full left-0 mb-2 px-3 py-2 bg-slate-800 text-white text-xs sm:text-sm rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 z-10 max-w-xs break-words">
                      {client_id}
          ...
          <div className="glass-card-hover p-3 sm:p-4 relative overflow-hidden dark">
            ...
            <div className="flex items-center space-x-3 sm:space-x-4">
              ...
              <div className="min-w-0 flex-1">
                <p className="text-xs sm:text-sm font-medium text-slate-400">Items</p>
        ...
        <div className="glass-card-hover p-3 sm:p-4 dark">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
            <div className="flex items-center space-x-3 sm:space-x-4">
              ...
              <div>
                <p className="text-xs sm:text-sm font-medium text-slate-400">Total Amount</p>
