...
const ImageUploader = ({ onUpload, isLoading, error, darkMode }) => {
  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      {/* Main Upload Area */}
      <div className={`glass-card p-4 sm:p-6 lg:p-8 ${darkMode ? 'dark' : ''}`}>
        <div
          {...getRootProps()}
          className={`
            dropzone
            ...
            <div className="space-y-4 sm:space-y-6">
              <div className="flex justify-center">
                <div className="relative">
                  ...
                  <div className="absolute -top-1 -right-1 sm:-top-2 sm:-right-2 w-6 h-6 sm:w-8 sm:h-8 bg-white dark:bg-slate-800 rounded-full flex items-center justify-center shadow-lg">
              ...
              <div className="space-y-2 sm:space-y-3">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center space-y-2 sm:space-y-0 sm:space-x-6 text-xs sm:text-sm text-slate-500 dark:text-slate-400">
      ...
      {/* Error Display */}
      {error && (
        <div className="glass-card p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800">
